...
#include "David_Nixon_Learn/TP_WeaponComponent.h"
...
// Cross Module References
	...
	DAVID_NIXON_LEARN_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
	DAVID_NIXON_LEARN_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(ADavid_Nixon_LearnCharacter,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			ADavid_Nixon_LearnCharacter* TargetCharacter;
		};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTP_WeaponComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 1650547
	...
	template<> DAVID_NIXON_LEARN_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTP_WeaponComponent);
	UTP_WeaponComponent::~UTP_WeaponComponent() {}
	struct Z_CompiledInDeferFile_FID_UE5_2_Tencent_gam_dev_note_Projects_David_Nixon_Learn_Source_David_Nixon_Learn_TP_WeaponComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_2_Tencent_gam_dev_note_Projects_David_Nixon_Learn_Source_David_Nixon_Learn_TP_WeaponComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 2476580260U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_2_Tencent_gam_dev_note_Projects_David_Nixon_Learn_Source_David_Nixon_Learn_TP_WeaponComponent_h_1422731215(TEXT("/Script/David_Nixon_Learn"),
		Z_CompiledInDeferFile_FID_UE5_2_Tencent_gam_dev_note_Projects_David_Nixon_Learn_Source_David_Nixon_Learn_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE5_2_Tencent_gam_dev_note_Projects_David_Nixon_Learn_Source_David_Nixon_Learn_TP_WeaponComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
